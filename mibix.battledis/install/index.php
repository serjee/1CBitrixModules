...
if (class_exists("mibix.battledis")) return;

class mibix_battledis extends CModule
{
    const MODULE_ID = "mibix.battledis";
    var $MODULE_ID = "mibix.battledis";
    var $MODULE_VERSION;
	...
	// Конструктор
    function mibix_battledis()
    {
        $arModuleVersion = array();
        include(dirname(__FILE__)."/version.php");
        $this->MODULE_VERSION = $arModuleVersion["VERSION"];
        $this->MODULE_VERSION_DATE = $arModuleVersion["VERSION_DATE"];
        $this->MODULE_NAME = GetMessage("MIBIX_BATTLEDIS_MODULE_NAME");
        $this->MODULE_DESCRIPTION = GetMessage("MIBIX_BATTLEDIS_MODULE_DESCRIPTION");
	...
	function InstallFiles()
	{
        ...
        CopyDirFiles(
            $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/".self::MODULE_ID."/install/components/mibix/",
	...
	function UnInstallFiles()
	{
        ...
        // component
        DeleteDirFilesEx("/bitrix/components/mibix/battle.discounts");
        // css
        ...
        // module's root files
        DeleteDirFilesEx("/mibix_battledis_cron.php");
    ...
    function DoInstall()
    {
        ...
        $APPLICATION->IncludeAdminFile(GetMessage("MIBIX_BATTLEDIS_INSTALL_TITLE") . self::MODULE_ID, $DOCUMENT_ROOT."/bitrix/modules/".$this->MODULE_ID."/install/step.php");
        return true;
    }
    ...
    function DoUninstall()
    {
        ...
        $APPLICATION->IncludeAdminFile(GetMessage("MIBIX_BATTLEDIS_UNINSTALL_TITLE") . self::MODULE_ID, $DOCUMENT_ROOT."/bitrix/modules/" . $this->MODULE_ID . "/install/unstep.php");
        return true;
    }
}