...
if($RIGHT >= "R") :
    ...
    // путь для ссылки
    $settingsPath = 'http://'.$_SERVER['HTTP_HOST'].'/bitrix/admin/mibix.battledis_service_index.php?lang=ru';

    $tabControl->Begin();
    $tabControl->BeginNextTab();
    ?>
    <tr>
        <td colspan="2" valign="top" width="50%"><a href="<?=$settingsPath?>"><?=GetMessage("MIBIX_BATTLEDIS_LINK")?></a></td>
    </tr>
<?endif?>
<?$tabControl->End();?>