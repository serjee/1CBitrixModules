 ...
 * магазина создайте копию данного скрипта с новым именем в корне сайта и в его параметре
...
$YAM_EXPORT = CMibixGoogleExport::get_profile_step_settings($SHOP_ID);
if(is_array($YAM_EXPORT) && count($YAM_EXPORT) > 0)
{
    ...
    CMibixGoogleExport::CreateYML($YAM_EXPORT_PATH, $YAM_EXPORT_LIMIT, true, $SHOP_ID);
}
else
{
