<?
$MESS['MIBIX_INSTRUCTION_TITLE'] = 'Инструкция модуля "Универсальная выгрузка"';
$MESS['MIBIX_CONTENT_TEXT'] = '
    ...
    <ul>
        <li>
            ...
            <ul>
                ...
                <li><a href="#INSTR_20">Два способа формирования XML-файла</a></li>
            </ul>
        </li>
        <li>
            <h4>Настройка выгрузки в Google Merchant</h4>
            <ul>
    ...
    <br />
    <br />
    <h3>Два (три) способа формирования XML-файла</h3>
    <p>После того, как Вы произвели необходимые настройки экспорта, перечисленные в предыдущем пункте, можно <b>получить XML-файл</b> двумя способами:</p>
    <h4>1. "НА ЛЕТУ"</h4>
    <p>Производится запуском файла "/<b>mibix_google_export.php</b>", который расположен <b>в корне сайта</b>. В результате будет сгенерирован XML-файл и Вы сразу получите его содержимое.</p>
    ...
    <p><span class="mibix_ins_note">Пошаговая выгрузка дает вам возможность выгружать неограниченное количество товаров в XML-файл в условиях ограниченных ресурсов сервера или хостинга</span>.</p>
    <p><b>Для пошаговой выгрузки предусмотрено отдельно 2 способа</b>:</p>
    <ul>
        <li><b>Через браузер</b> - производится запуском скрипта <b>/mibix_google_create.php</b> в браузере.</li>
        <li><b>Через CRON</b> - производится установкой вызова скрипта <b>/mibix_google_cron.php</b> через CRON.</li>
    </ul>
    ...
    <p><b>Что если скрипт не успеет отработать за это время?</b> Да, CRON запустит его повторно, но он не станет выполняться, так как увидит, что предыдущий вызов скрипта еще не завершен.</p>
    ...
    <a name="INSTR_30"></a>
    <br />
    <h2>Настройки выгрузки в Google Merchant</h2>

    <h3>Общие сведения</h3>
    <p>Во вкладке "Общие сведения" необходимо задать базовые настройки выгрузки в Google Merchant. Как минимум, нужно заполнить поля помеченные как "обязательные". Кроме того, здесь же Вы можете задать UTM-метки, для сбора собственной статистики переходов по ссылкам на товары.</p>
    ...
    <p>В разделе "Источники данных" Вы группируете разделы и/или товары Вашего каталога со схожими свойствами, которые собираетесь выгружать в Google Merchant.</p>
    ...
    <p>В разделе "Правила выгрузки" Вы задаете правила формирования необходимых данных для экспорта в Google Merchant.</p>
    ...
    <p>В режиме добавления и редактирования "Правила выгрузки" необходимо указать созданный для него "Источник данных", а также задать другие необходимые настройки.</p>
    <img src="#image_path#INSTR_50_20.png" alt="" />
    <p>После того, как Вы создали все необходимые Вам "Правила выгрузки" и назначили им индивидуальные "Источники данных", то смело можно сгенерировать полученный результат в виде XML-файла одним из двух способов, описанных ранее.</p>
';
?>