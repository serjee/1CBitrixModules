...
<div class="mbx-panel panel-battle-simple">
    ...
    <div class="panel-battle-body">
        ...
        <div class="panel-battle-body-item" style="width: <?=$arResult["COLUMN_WIDTH"]?>% !important;">
            <div class="panel-battle-body-item-column">
                <div class="title"><h2><?=$battleVal["NAME"];?></h2></div>
                <div class="block-center block-images">
                    <?
                    $i=0;
                ...
                <div class="block-center block-desc"><?=strip_tags($battleVal["DESC"]);?></div>
                <?endif;?>
                ...
                ?>
                <div class="block-center block-bottom">
                    <div class="ai_price"><? echo $battleVal["VOTES"] . " " . $battleVal["VOTES_STRING"];?></div>
                    <div class="ai_discounted">
                        <a class="btn btn-primary<?if($arResult["BATTLE_END"]){echo " disabled";};?> vote-popup-open" href="javascript:void(0)" onclick="setBattleID(<?=$uID;?>)"><?=GetMessage("MIBIX_BATTLE_TMP_ITEM_VOTE")?></a>
                    </div>
                </div>
            </div>
        </div>
