...
if (class_exists("mibix.battle")) return;

class mibix_battle extends CModule
{
    const MODULE_ID = "mibix.battle";
    var $MODULE_ID = "mibix.battle";
    var $MODULE_VERSION;
	...
	// Конструктор
    function mibix_battle()
    {
        $arModuleVersion = array();
        include(dirname(__FILE__)."/version.php");
        $this->MODULE_VERSION = $arModuleVersion["VERSION"];
        $this->MODULE_VERSION_DATE = $arModuleVersion["VERSION_DATE"];
        $this->MODULE_NAME = GetMessage("MIBIX_BATTLE_MODULE_NAME");
        $this->MODULE_DESCRIPTION = GetMessage("MIBIX_BATTLE_MODULE_DESCRIPTION");
	...
	function UnInstallFiles()
	{
        ...
        // component
        DeleteDirFilesEx("/bitrix/components/mibix/battle.simple");
        // css
        ...
        // module's root files
        DeleteDirFilesEx("/mibix_battle_cron.php");
    ...
    function DoInstall()
    {
        ...
        $APPLICATION->IncludeAdminFile(GetMessage("MIBIX_BATTLE_INSTALL_TITLE") . self::MODULE_ID, $DOCUMENT_ROOT."/bitrix/modules/".$this->MODULE_ID."/install/step.php");
        return true;
    }
    ...
    function DoUninstall()
    {
        ...
        $APPLICATION->IncludeAdminFile(GetMessage("MIBIX_BATTLE_UNINSTALL_TITLE") . self::MODULE_ID, $DOCUMENT_ROOT."/bitrix/modules/" . $this->MODULE_ID . "/install/unstep.php");
        return true;
    }
}