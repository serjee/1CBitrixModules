...
if (class_exists("mibix_basket")) return;
class mibix_basket extends CModule
{
    var $MODULE_ID = "mibix.basket";
    var $MODULE_VERSION;
	...
	{
        DeleteDirFilesEx("/bitrix/components/mibix/basket.available");
        DeleteDirFilesEx("/bitrix/js/mibix.basket.available");
